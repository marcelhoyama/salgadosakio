...
<div class="row" >
    ...
    <div class="col-xs-12 col-sm-3">
     ...
     <div class="col-xs-12 col-sm-3">
        <div class="thumbnail">
       <div class="caption">
        <h3>Sabor de Frango com Requeijão</h3>
        <p></p>
